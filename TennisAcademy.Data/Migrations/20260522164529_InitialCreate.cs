        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastWheelSpinDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Brand = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Bag Brand in English"),
                    BrandBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Bag Brand in Bulgarian"),
                    Model = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Bag Model in English"),
                    ModelBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Bag Model in Bulgarian"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Ball Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Brand = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ball Brand in English"),
                    BrandBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ball Brand in Bulgarian"),
                    Model = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ball Model in English"),
                    ModelBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ball Model in Bulgarian"),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, comment: "Ball Price"),
                    Quantity = table.Column<int>(type: "int", nullable: false, comment: "Available in stock"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Ball Image"),
                    LastModified_22180021 = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Racket Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Brand = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Racket Brand in English"),
                    BrandBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Racket Brand in Bulgarian"),
                    Model = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Racket Model in English"),
                    ModelBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Racket Model in Bulgarian"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Surface Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Surface Name in English"),
                    NameBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Surface Name in Bulgarian"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Image of the surface"),
                    LastModified_22180021 = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Training Type Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Training Type Name in English"),
                    NameBg = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Training Type Name in Bulgarian"),
                    LastModified_22180021 = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalityBg = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true, comment: "Identity User Identifier linked to this coach"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    LastModified_22180021 = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Reservation Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Note = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: true, comment: "Player Notes in English"),
                    NoteBg = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Player Notes in Bulgarian"),
