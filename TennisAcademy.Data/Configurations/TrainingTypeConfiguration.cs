...
namespace TennisAcademyApp.Data.Configurations
{
    public class TrainingTypeConfiguration : IEntityTypeConfiguration<TrainingType>
    {
        ...
        {
            config
                .HasData(SeededTrainingTypes());
        }
        private List<TrainingType> SeededTrainingTypes()
        {
            List<TrainingType> seededTrainingTypes = new List<TrainingType>()
            {
                new TrainingType
                {
                    Id = 1,
